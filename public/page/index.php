...
$pissum =  $obj->person_sum();
$ressum = mysqli_fetch_assoc($pissum);
$ps     = $ressum['person_sum'];
?>
    ...
    <div class="mt-3">
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <?php
                    $piscount =  $obj->person_count();
                    while ($result = mysqli_fetch_assoc($piscount)) {
                        $pt = $result['person_total'];
                        $pc = $pt / $ps * 100;
                    ?>
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <span class="info-box-icon <?= $result['bg_color']; ?> elevation-1"><i class="fas fa-users"></i></span>
                                <div class="info-box-content">
                                    <span class="info-box-text"><?= $result['pn']; ?></span>
                                    <span class="info-box-number"><?= $result['person_total']; ?> คน</span>
                                    <span class="description-percentage text-success"><i class="fas fa-chart-line"></i> <?= number_format($pc, 2); ?>%</span>
                                    <div class="progress progress-sm">
                                        <div class="progress-bar <?= $result['bg_color']; ?>" style="width: <?= $pc; ?>%">"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
