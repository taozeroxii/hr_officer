                    ...
                    <?php } else { ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class='row mt-5'>
                                <div class='col-12'>กลุ่มภารกิจ ( Mission ): <select id='brand' name='mission_id' class='form-control' required>";
                                        ...
                                        while ($row = mysqli_fetch_array($sqlmission)) {          ?>
                                            <option value="<?= $row['mission_id']; ?>" <?php if ($mission_id == $row['mission_id']) {  echo 'selected';   } ?>> <?= $row['mission_name']; ?></option>
                                        <?php   }  ?>
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="workgroup_name" value="<?php if ($workgroup != '' || $workgroup != null) {    echo $workgroup;         } else {  echo '';   } ?>" id="workgroup_name" required>
                            </div>
                            <?php if (!isset($id)) { ?>
